...
function acf_404() { ?>
    <div class="update-nag">
        <p><a href="http://advancedcustomfields.com">
        	<?php _e('ACF Widgets Requires ACF to function properly. Please activate ACF v5 to remove this message. If ACF is installed, make sure you are using v5 or later.', 'acf-widgets'); ?>
        </a></p>
    </div>
<?php }