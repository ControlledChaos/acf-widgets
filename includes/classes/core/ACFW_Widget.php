...
class ACFW_Widget extends WP_Widget {
	...
	function __construct ( $params ) {
		...
		parent::__construct(
			$this->data_id,
			__( $this->title, 'acf-widgets' ), // Name
			array(
				'description' => __( $this->description, 'acf-widgets' ),
    ...
    function form($instance) {
    	...
    	<?php endif; ?>
            ...
            <p class='acfw-no-acf'><?php _e( 'You have not added any fields to this widget yet.', 'acf-widgets' ); ?>

                <br/><br/>

                <a href='post-new.php?post_type=acf-field-group'><?php _e( 'Add some now!', 'acf-widgets' ); ?></a>

                <br/><br/>

                <?php _e( 'Make sure to set the location rules to:', 'acf-widgets' ); ?>

                <b><?php _e( 'Widget : is equal to : ', 'acf-widgets' ); echo $this->title; ?></b>
