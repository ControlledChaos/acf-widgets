	...
	$register_field_group_function(array (
		...
		'fields' => array (
			array (
				...
				'label' => __('Custom Field Location', 'acf-widgets'),
				...
				'conditional_logic' => 0,
				'choices' => array (
					'before' => __('Before Title', 'acf-widgets'),
					'after' => __('After Title (title required)', 'acf-widgets'),
					'end' => __('After Widget', 'acf-widgets'),
				),
				'default_value' => array (
					'end',
				),
